...
//                            // 绘制胶囊体
//                            DrawCapsule(worldCenter, worldRotation, hitboxAsset.config.height, hitboxAsset.config.radius);
...
//    // 绘制胶囊体
//    private static void DrawCapsule(Vector3 center, Quaternion rotation, float height, float radius)
//    {
//        // 计算圆柱部分高度
...
//        // 绘制顶部和底部的半球
//        DrawHemisphere(topCenter, rotation, radius, true);
//        DrawHemisphere(bottomCenter, rotation, radius, false);
//    }

//    // 绘制半球
//    private static void DrawHemisphere(Vector3 center, Quaternion rotation, float radius, bool isTop)
//    {
//        // 确定半球的方向（上或下）
